inp = """-J.|..|7F-J7.J7F7.-77LJ-FL-F77F77F7|F-FLF7.F.FL7F-J.|.FF7-|-F7F7F7.FF-F7LL7FF-J7.----77-FF-..JF7.L-.FF|-F7--|7F77L7FF77F77.FL-7-L.FL7.FF-7..
...
d = {"|": "ns", "-": "ew", "L": "ne", "J": "nw", "7": "sw", "F": "se", "S": "ne"}
...
while True:
        ...
        for i in potential:
            ...
            if i == prev:
                continue
            c = checkValid(i, path[-1] , direction)
            if c[0]:
                path.append(i)
                prev = path[-2]
                direction = c[1]
