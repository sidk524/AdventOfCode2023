inp = """416.........................559...............417...............785.......900.......284...........503...796....992..........................
...
...........................51.......681........................271..........719.......................964......399..426...............456...""".split("\n")

inp = [list(x) for x in inp]
marked = [[False for j in range(len(x))] for x in inp]

def getSurroundingNumber(inp, row, col, startDig):
    num = ""
    numI = []
    for i in range(-2, 3):
        if 0 <= col+i < len(inp[0]):
            if i < 0:
                start = col+i
                end = col
            else:
            ...
            cont = False
            for x in inp[row][start:end]:
                if not(x.isdigit()):
                    cont = True
                    break
            if cont:
                continue
            elif inp[row][col+i].isdigit():
                numI.append((row, col+i))
                num += inp[row][col+i]
...
def getAdjacent(inp, row, col):
    ...
    for i in range(-1, 2):
        for j in range(-1, 2):
            if i == j == 0:
                continue
            if 0 <= row+i < len(inp) and 0 <= col+j < len(inp[0]):
                if inp[row+i][col+j].isdigit():
                    nums.append(getSurroundingNumber(inp, row+i, col+j, inp[row+i][col+j]))
